[![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=Silva22211767/Practica3GD)
...
El objetivo es desarrollar e implementar un algoritmo en el entorno de MATLAB para el análisis y procesamiento de datos numéricos mediante el uso de scripts interactivos (Live Scripts). El sistema busca facilitar la visualización de resultados, la resolución de ecuaciones matemáticas y la generación de reportes técnicos integrados que permitan validar el comportamiento de un modelo teórico frente a datos simulados o experimentale.
